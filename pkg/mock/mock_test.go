...
func Test_NewMock(t *testing.T) {
	...
	t.Run("AssertExpectations called at test end", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectError()
		wMsg := tstkit.Golden(t, "testdata/mock_cleanup_assert_error.txt")
...
func Test_Mock_On(t *testing.T) {
	...
	t.Run("variadic method", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/call_unexpected_variadic.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
...
func Test_Mock_Call(t *testing.T) {
	...
	t.Run("call method too many times", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/mock_too_many_calls.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
	...
	t.Run("call existing method with different arguments", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/call_found_args_dont_match.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
	...
	t.Run("error call to not expected method name", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/call_not_found_with_args.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
	...
	t.Run("call before required deps are met", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/call_deps_not_met.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
	...
	t.Run("call before some required deps are met", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/call_deps_some_not_met.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
	...
	//
	// 	mck := NewMock(tspy)
	// 	call0 := mck.On("ConcurrencyTestMethod")
	//
	// 	wg := sync.WaitGroup{}
	// 	wg.Add(2)
	//
	...
	// 		for i := 0; i < cnt; i++ {
	// 			mck.Call("ConcurrencyTestMethod")
	// 		}
	// 		wg.Done()
	// 	}()
	//
	// 	// --- Then ---
	// 	wg.Wait()
	// 	assert.Equal(t, cnt, call0.haveCalls)
	// assert.False(t, mck.failed)
	// })
...
func Test_Mock_AssertExpectations(t *testing.T) {
	...
	t.Run("one not satisfied", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/missing_calls_one.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
	...
	t.Run("multiple not satisfied", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/missing_calls_multiple.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
	...
	t.Run("matcher panics", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/mock_matcher_panics.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
...
func Test_Mock_IsCallable(t *testing.T) {
	t.Run("callable", func(t *testing.T) {
		...
		// --- When ---
		err := mck.IsCallable("MethodIntVar", 42, 44)
	...
	t.Run("not existing method", func(t *testing.T) {
		...
		// --- When ---
		err := mck.IsCallable("NotExisting")
	...
	t.Run("not matching arguments", func(t *testing.T) {
		...
		// --- When ---
		err := mck.IsCallable("MethodIntVar", 7, 44)
...
func Test_Mock_String(t *testing.T) {
	// --- Given ---
	tspy := tester.New(t)
	tspy.ExpectCleanups(1)
	tspy.Close()
	...
	// --- Then ---
	assert.True(t, strings.HasPrefix(have, "*mock.Mock<"))
	assert.True(t, strings.HasSuffix(have, ">"))
}
...
func Test_Mock_find(t *testing.T) {
	...
	t.Run("error matching name not matching arg count", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrNotFound)
		wMsg := tstkit.Golden(t, "testdata/find_fail_arg_count.txt")
	...
	t.Run("error method name call not found", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrNotFound)
		wMsg := tstkit.Golden(t, "testdata/find_call_fail_no_args.txt")
		assert.ErrorEqual(t, wMsg, err)
		assert.Nil(t, have)
	})
	...
	t.Run("error method name call not found with arguments", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrNotFound)
		wMsg := tstkit.Golden(t, "testdata/find_call_fail_with_args.txt")
		assert.ErrorEqual(t, wMsg, err)
		assert.Nil(t, have)
	})
	...
	t.Run("error matching name not matching arg type", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrNotFound)
		wMsg := tstkit.Golden(t, "testdata/find_call_fail_arg_type.txt")
		assert.ErrorEqual(t, wMsg, err)
		assert.Nil(t, have)
	})
	...
	t.Run("error method with variadic args not found", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrNotFound)
		wMsg := tstkit.Golden(t, "testdata/find_fail_variadic_arg_count.txt")
		assert.ErrorEqual(t, wMsg, err)
		assert.Nil(t, have)
	})
	...
	t.Run("error when matcher panics", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrNotFound)
		wMsg := tstkit.Golden(t, "testdata/find_fail_panicking_matcher.txt")
		assert.ErrorEqual(t, wMsg, err)
		assert.Nil(t, have)
	})
	...
	t.Run("error too many calls to proxy method", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrTooManyCalls)
		wMsg := tstkit.Golden(t, "testdata/find_fail_too_many_calls.txt")
		assert.ErrorEqual(t, wMsg, err)
		assert.Nil(t, have)
	})
	...
	t.Run("error with stack", func(t *testing.T) {
		...
		// --- Then ---
		assert.ErrorIs(t, err, ErrNotFound)
		wMsg := tstkit.Golden(t, "testdata/find_fail_with_stack.txt")
		assert.ErrorEqual(t, wMsg, err)
		assert.Nil(t, have)
	})
}
...
func Test_Mock_Unset(t *testing.T) {
	...
	t.Run("not existing call", func(t *testing.T) {
		...
		tspy.ExpectCleanups(1)
		tspy.ExpectFail()
		wMsg := tstkit.Golden(t, "testdata/unset_method_not_found.txt")
		tspy.ExpectLogEqual(wMsg)
		tspy.Close()
