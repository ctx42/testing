...
- `WithSrc(src string)`: the source package or directory.
  Defaults to the current package.
- `WithTgt(tgt string)`: the target package or directory for the
  generated mock. Defaults to the current package.
- `WithTgtOutput(w io.Writer)`: directs the mock output to the given
  writer. Defaults to a file named `<interface>_mock.go`.
...
- `WithTesterAlias(alias string)`: sets alias for the tester import
  in the generated file. Defaults to "_tester".
